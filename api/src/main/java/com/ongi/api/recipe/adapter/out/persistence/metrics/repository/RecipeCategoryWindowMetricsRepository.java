...
import com.ongi.api.recipe.adapter.out.persistence.metrics.RecipeCategoryWindowMetricsEntity;
import com.ongi.api.recipe.adapter.out.persistence.metrics.RecipeCategoryWindowMetricsId;
...
@Repository
public interface RecipeCategoryWindowMetricsRepository extends JpaRepository<RecipeCategoryWindowMetricsEntity, RecipeCategoryWindowMetricsId> {
  ...
  @Query(value = """
    ...
    LEFT JOIN recipe_category_window_metrics w
      ON w.as_of_date = :asOfDate
     AND w.window_days = :windowDays
